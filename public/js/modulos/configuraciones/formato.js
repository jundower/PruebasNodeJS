...
$(document).ready(function() {
    ...
    motivo_serie_documento=$("#motivo_serie_documento").text();
...
function guardar(){
    ...
    $.ajax({
        ...
        data:{
            ...
            motivo_serie_documento: motivo_serie_documento,
            propiedades: JSON.stringify(propiedades)
        },
        success: function (result){
            result[0]>=1 ? mostrarMensajeModal("Aviso","Formato Actualizado"):mostrarMensajeModal("Aviso",result);
        }
    });
}
function nuevo(){
    ...
    for(var i= 0; i<campos.length;i++){
        ...
        //Rellenando los campos en el formato
        ...
        jq_formato_impresion.append(div_campo);
        ...
        //Rellenando las configuraciones de los campos
...
function imprimir(){
    jq_formato_impresion.printThis();
}
function validar(){
    return true;
}