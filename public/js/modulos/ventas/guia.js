...
var url_configuracion_permisos = '/configuraciones/configuracion_permisos/proceso_ventas__sist_venta_facturacion__guia_remision';
...
$(document).ready(function() {
    ...
    jq_tipo.change(function() {
        ...
        switch (val) {
            ...
            case "GUIA DE FACTURA":
                $("#buscar_pendientes").prop( "disabled", false );
                setVentasPendientes('Facturas Pendientes','/facturacion/lista_documentos_pendientes','/facturacion/lista_detalle_pendientes','01');
                $("#modal_pendientes").modal("show");
                break;
    ...
    setListaDocumentos('/guia/lista', '/guia/consultar', '/guia/detalle','Serie','listado_documentos');
    setVentasPendientes('Pedidos Pendientes','/pedido/lista_documentos_pendientes','/pedido/lista_detalle_pendientes');
...
function guardar(){
    ...
    switch (estado) {
        case 'guardar':
            url_guardar = "/guia/guardar";
            mensaje = "Guardado satisfactoriamente."
            impresion=true;
            break;
        case  'modificar':
            url_guardar = "/guia/modificar";
            mensaje = "Modificado satisfactoriamente."
            break;
        case 'eliminar':
            url_guardar = "/guia/eliminar";
            mensaje = "Eliminado satisfactoriamente."
            break;
        case 'anular':
            url_guardar = "/guia/anular";
...
function agregar_cabecera_pendientes(rowData){
    ...
    // jq_vehiculo.val();
    // jq_motivo_traslado.val();
    var url_comentarios = "/facturacion/comentarios";
