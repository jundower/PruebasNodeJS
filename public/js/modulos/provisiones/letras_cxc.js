...
var url_configuracion_permisos = '/configuraciones/configuracion_permisos/proceso_provisiones__sist_letras_CXC__canje_letras_cxc';
...
$(document).ready(function() {
    ...
    jq_tipo_letra.change( function(){
        var url_documentos_pendientes = jq_tipo_letra.val() == 'CANJE'? '/letras/lista_documentos_pendientes':'/letras/lista_letras_renovacion';
        setListaDocumentosContables(url_documentos_pendientes, 'listado_documento_contables');
    })
    ...
    setListaDocumentosContables('/letras/lista_documentos_pendientes', 'listado_documento_contables');
    detalle_letras();
    nuevo();  
});
