...
//var url_configuracion_permisos = '/configuraciones/configuracion_permisos/proceso_almacen__sist_almacen__reportes__inventario_valorizado';
...
async function rellenar_selects(){
    ...
    $("#punto_venta").append('<option value="(TODOS)" >(TODOS)</option>');
...
function cargar_lista_productos(){
    ...
    grid_lista_productos.jqGrid({
        url: '/reportes_almacen/productos/',
        mtype: "POST",
        datatype: "json",
        postData: {
...
function rellenarKardex(data){
    ...
    for(var i = 0; i<data.length; i++){
        ...
        if((header_height + footer_height + content_height < page_height ) && (page_number!=0)){
            ...
            new_fila = new_fila.replace("print_body_codigo","COD. EXISTENCIA : "+detalle.Codigo)
            new_fila = new_fila.replace("print_body_descripcion","DESCRIPCION : "+detalle.Nombre)
            new_fila = new_fila.replace("print_body_unidad","UM : "+detalle.Unidad)
            new_fila = new_fila.replace("print_body_familia","FAMILIA : "+detalle.Familia)
            ...
            new_page = new_page.replace("print_body_codigo","COD. EXISTENCIA : "+detalle.Codigo)
            new_page = new_page.replace("print_body_descripcion","DESCRIPCION : "+detalle.Nombre)
            new_page = new_page.replace("print_body_unidad","UM : "+detalle.Unidad)
            new_page = new_page.replace("print_body_familia","FAMILIA : "+detalle.Familia)
