...
var url_productos_punto_ventas= '/productos/punto_venta/';
...
var grid_productos_punto_ventas = "lista_productos_punto_venta";
...
$(document).ready(function() {
    ...
    jq_grid_productos_punto_ventas=$("#"+grid_productos_punto_ventas);
    cargar_configuracion_lista_productos();
    cargar_grid_productos_punto_ventas();
    ...
    jq_modal_productos.on('shown.bs.modal', function () {
        ...
        jq_grid_productos_punto_ventas.setGridHeight($("#modal_parent_lista_productos_content").height()*0.15);
        jq_grid_productos_punto_ventas.setGridWidth($("#parent_lista_productos_unidades").width());
...
function cargar_grid_productos_punto_ventas() {
    var jq_grid = jq_grid_productos_punto_ventas;

    jq_grid.jqGrid({
        url: url_productos_punto_ventas,
        mtype: "POST",
        datatype: "json",
        colNames: ['Codigo','Punto de Venta','Direccion'],
        colModel:[
