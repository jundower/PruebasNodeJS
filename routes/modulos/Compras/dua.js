...
router.post('/configuraciones2', async (req, res) => {
    const codigo_empresa = req.user.codigo_empresa;
    const pool = await poolPromise;
    const lista = await pool
    .request()
    ...
    .query(
     "select   \n"+
     "erp_porcperc as Porcentaje_Percepcion, \n"+
     "importaciones_mas_igv as Importaciones_Mas_Igv  \n"+
     "from HCONFIGURACIONES where IdEmpresa  = @codigo_empresa \n"
    );
...
router.post('/detalle', async (req, res) => {
    ...
    .query(
        " select  \n"+
        " hdepositod.nitem as NItem, \n"+
        " hdepositod.ncantidad2 as Cantidad, \n"+
        " hdepositod.ccod_articulo as Codigo, \n"+
        " Harticul.ccod_interno as Codigo_Fabricante, \n"+
        " hdepositod.cnom_articulo as Nombre, \n"+
        " hdepositod.cunidad as Codigo_Unidad, \n"+
        " hdepositod.cunidad as Unidad, \n"+
        " hdepositod.ncantidad3 as Factor, \n"+
        " hdepositod.fob_uni as Unit, \n"+
        " hdepositod.fob as Importe, \n"+
        " hdepositod.flete as Flete, \n"+
        " hdepositod.seguro as Seguro, \n"+
        " hdepositod.otros as Otros, \n"+
        " hdepositod.erp_nro_arancel as Numero_Partida, \n"+
        " hdepositod.erp_porc_adv as Adv_Porcentaje, \n"+
        " hdepositod.erp_porc_conv as Convenio, \n"+
        " hdepositod.erp_signo_sobretasa as Codigo_Signo, \n"+
        " hdepositod.erp_signo_sobretasa as Signo, \n"+
        " hdepositod.erp_porc_sobretasa as Sobretasa, \n"+
        " hdepositod.erp_conv_mn_unit as Conv_Mn, \n"+
        " hdepositod.erp_conv_me_unit as Conv_Me, \n"+
        " hdepositod.fob_otros as Fob_Otros, \n"+
        " hdepositod.erp_adv_mn_unit as Adv_Mn_Unit, \n"+
        " hdepositod.erp_adv_me_unit as Adv_Me_Unit, \n"+
        " hdepositod.erp_porc_isc as Porc_Isc, \n"+
        " hdepositod.erp_mont_isc as Monto_Isc, \n"+
        " hdepositod.erp_sobretasa_mn_unit as Sobretasa_Mn_Unit, \n"+
        " hdepositod.erp_sobretasa_me_unit as Sobretasa_Me_Unit, \n"+
        " hdepositod.flete_uni as Flete_Unit, \n"+
        " hdepositod.seguro_uni as Seguro_Unit, \n"+
        " hdepositod.otros_uni as Otros_Unit, \n"+
        " '' as Total_Adv_Mn, \n"+
        " '' as Total_Adv_Me, \n"+
        " hdepositod.cnum_doc_ref as Numero_Ref, \n"+
        " hdepositod.nitem_ref as Item_Ref, \n"+
        " hdepositod.motivo as Motivo_Ref, \n"+
        " hdepositod.cencos as Codigo_Cencos, \n"+
        " hdepositod.cencos as Cencos, \n"+
        " hdepositod.ot as Codigo_Ot, \n"+
        " hdepositod.ot as Ot, \n"+
        " hdepositod.ncantidad as Cantidad_Kardex, \n"+
        " hdepositod.barticulo as Barticulo, \n"+
        " hdepositod.peso as Peso, \n"+
        " hdepositod.largo as Largo, \n"+
        " hdepositod.ancho as Ancho, \n"+
        " hdepositod.erp_gasmn as Erp_Gasmn, \n"+
        " hdepositod.erp_gasme as Erp_Gasme, \n"+
        " hdepositod.Erp_Dua as  Numero_Dua, \n"+
        " hdepositod.Erp_invoice as Numero_Invoice, \n"+
        " hdepositod.Erp_Num_Importacion as Numero_Importacion, \n"+
        " hdepositod.erp_tc_dep as Erp_Tc, \n"+
        " hdepositod.Erp_Agent_aduana as Agente_Aduana, \n"+
        " hdepositod.ptovta_ref2 as PtoVta_Referencia2, \n"+
        " hdepositod.tipdoc_ref2 as Tipo_Documento_Referencia2, \n"+
        " hdepositod.motivo_ref2 as Motivo_Referencia2, \n"+
        " hdepositod.nro_ref2 as Numero_Referencia2, \n"+
        " hdepositod.cnum_lote as Lote, \n"+
        " hdepositod.erp_impmn as Ipm_Mn, \n"+
        " hdepositod.erp_impme as Ipm_Me, \n"+
        " hdepositod.erp_num_expediente as Numero_Expediente \n"+
        " from hdepositod inner Join Harticul On  \n"+
        " hdepositod.ccod_empresa = Harticul.ccod_empresa and \n"+
        " hdepositod.ccod_articulo = Harticul.ccod_articulo \n"+
        " where hdepositod.ccod_empresa = @codigo_empresa and cnum_doc_dep = @numero_documento \n"+
        " order by nitem \n"
    );
    const recordset = lista.recordset;
...
router.post('/lista', async (req, res) => {
    try {
        ...
        .query(
            ...
            "MONTH(Hordcomc.dfecha_doc) = @mes AND YEAR(Hordcomc.dfecha_doc) = @anio \n"+
...
router.post('/consultar', async (req, res) => {
    try {
        ...
        .query(
            ...
            "Hproveed.cnum_ruc as proveedor_ruc, \n"+
