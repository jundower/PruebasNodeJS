...
router.get('/cancelacion',isLoggedin,async (req, res) => {
    res.render("modulos/contabilidad/cancelacion");
});
...
router.post('/lista', async (req, res) => {
    try {
        ...
        .query(
           ...
           " Where movc.ccod_empresa = @codigo_empresa And \n"+
           " month(movc.dfecha_doc)= @mes And \n"+
           " year(movc.dfecha_doc) = @anio And  \n"+
           " movc.modulo_origen = 'C-B'\n"+
