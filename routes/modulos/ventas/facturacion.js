...
router.post('/guardar', async (req, res) => {
    try {
        ...
        await transaction.begin(async err => {
            try{
                error_detalle="Generación del correlativo automatico";
                ...
                error_detalle="Descuenta o no el stock";
                //#region Determinar si descuenta o no el stock
                if (req.body.tipo_documento == '08' || req.body.tipo == 'VENTA DIFERIDA' || req.body.tipo == 'NOTA DE CREDITO POR DESCUENTO' || req.body.tipo == 'ANTICIPO' || req.body.tipo == 'VENTA DIFERIDA DE PEDIDO') {
                    erp_dscto_stock = 'N';
                }else{
                ...
                error_detalle="Registro de la cabecera";
                ...
                error_detalle="Registro del detalle";
                //recorrer filas_Detalle
                // for (let i = 0; i < filas_detalle.length; i++) {
                //     var rowid = filas_detalle[i];
                    
                // }
                //Juntar códigos en una sola variable
                //guardar en un array, el codigo, cantidad kardex, el lote, serie y fecha de vencimiento de lote
                /*
                //consultar
select ERP_CODART, ERP_STOART, ERP_LOTART, ERP_VENLOT,
ERP_LOTART,
ERP_VENLOT,
ERP_NUMSER from HSTOCK where 
ERP_CODEMP='0000000001' and 
ERP_CODPTV='001' and 
ERP_CODALM='001' and 
ERP_CODART in ('000000002','00-00001') //Aquí van los códigos unidos
ERP_CODART in ("+variable+")
group by
ERP_CODART, ERP_STOART, ERP_LOTART, ERP_VENLOT,
ERP_LOTART,
ERP_VENLOT,
ERP_NUMSER 
//Se obtiene un array
//Comparar con el array, si la cantidad del kardex del producto con su lote o serie y fecha de vencimiento es menor o mayor, 
//Si es mayor o igual, guardar detalle
//Si es menor, terminar transaction con error
...
(ERP_CODART='000000002' and
ERP_LOTART='' and
ERP_VENLOT='01/01/1900' and
erp_numser='') or

(ERP_CODART='001-007' and
ERP_LOTART='' and
ERP_VENLOT='01/01/1900' and
erp_numser='5668465465')  or

(ERP_CODART='PROD01' and
ERP_LOTART='25001' and
ERP_VENLOT='02/02/2021' and
erp_numser='') or

(ERP_CODART='001009' and
ERP_LOTART='3' and
ERP_VENLOT='01/12/2021' and
erp_numser='') 
                ...
                */
                ...
                for (let i= 0; i< filas_detalle.length; i++){
                    ...
                    if((rowid.Stock_SN =="N" ||  rowid.Stock_SN=="") || (rowid.Stock_SN =="S" && rs_stock_producto.length>0 && rowid.Cantidad_Kardex <= rs_stock_producto[0].ERP_STOART) || (req.body.tipo_documento == '08' || req.body.tipo == 'VENTA DIFERIDA' || req.body.tipo == 'NOTA DE CREDITO POR DESCUENTO' || req.body.tipo == 'ANTICIPO' || req.body.tipo == 'VENTA DIFERIDA DE PEDIDO')){
                ...
                if(documento_saved){
                    error_detalle="Actualizar Correlativo";
                    ...
                    error_detalle="Guardar Anticipos";
                    ...
                    error_detalle="Obtener información de periodo y del ejercicio";
                    ...
                    error_detalle="Cuenta de Venta del Grupo Cliente";
                    //#region Cuenta de Venta del Grupo Cliente
                    //falta la cuenta detraccion <--------------------------------------
                    //falta la cuenta percepcion <--------------------------------------
                    ...
                    error_detalle="Cuentas para los anticipos de una factura";
                    ...
                    error_detalle="Cuentas para los IGV de una factura";
                    ...
                    error_detalle="Cuentas para los ICBPER de una factura";
                    ...
                    if(req.body.tipo == "ANTICIPO"){
                        ...
                        error_detalle="Cuenta de Anticipo del Grupo cliente";
                        ...
                        error_detalle="Cuenta de los productos";
                        //#region Cuenta de los productos
                        for (let i= 0; i< filas_detalle.length; i++){
                            rowid = filas_detalle[i];
                            if((rowid.costo_mn != 0 || rowid.costo_me != 0) ||  (req.body.tipo == 'VENTA DIFERIDA') ){
                        ...
                        error_detalle="Cuenta de los costos";
                    ...
                    error_detalle="Guardar Provision Cuentas por Cobrar";
                ...
                res.send({estado: false, codigo: "Err", mensaje: error_detalle+": "+ err.message});
            }
        });

    } catch (err) {
        res.send({estado: false, codigo: err.number, mensaje: error_detalle+": "+err.message});
    }
});
...
router.post('/comentarios', async (req, res) => {
    try {
        ...
        .input("ccod_almacen", mssql.VarChar(250), codigo_punto_venta)
        .input("CCOD_MOVIMIENTO", mssql.VarChar(250), req.body.tipo_documento)
        .input("ctip_movimiento", mssql.VarChar(250), 'S')
