    ...
    try {
        ...
        await transaction.begin(async err => {
            try{
                ...
                await qrcode.toFile(path.join(__dirname, '../../../public/erp/'+codigo_empresa+'/qr/'+ruc_empresa+'-'+'09'+'-'+req.body.motivo+'-'+numero_correlativo+'.png'),ruc_empresa+'|'+'09'+'|'+req.body.serie+'|'+numero_correlativo+'|'+req.body.erp_Digv+'|'+req.body.erp_Dimporte+'|'+req.body.fecha_doc+'|'+req.body.tipo_documento_cliente+'|'+req.body.codigo_cliente,{color: {light: '#0000'}},function(err){
                ...
                if(documento_saved){
                    if(req.body.automatico == "A"){
                        ...
                        if (req.body.tipo == 'GUIA DE FACTURA') {
                            ...
                            .input('subvoucher', mssql.VarChar(250), '49')
                            .query(
                                "declare  \n"+
                                "@correlativo int,  \n"+
                                "@contador int,  \n"+
                            ...
                            .input('ccod_svoucher', mssql.VarChar(250), '49')
                            ...
                            .input('ctip_docref', mssql.VarChar(250), '09')
                            .input('cserie_docref', mssql.VarChar(250), req.body.motivo)
                            ...
                            if (req.body.tipo == 'GUIA DE FACTURA') {
                                for (let i= 0; i< filas_detalle.length; i++){
                                    ...
                                    var calculos_mn_me = await helpers.getCalculosMnMe({
                                        ...
                                        Tc : req.body.tasa_cambio,
                                        Moneda : req.body.moneda,
                                        D_H: req.body.tipo_documento == "09" ? 'H' : 'D',
                                    });
                                    ...
                                    var calculos_mn_me = await helpers.getCalculosMnMe({
                                        ...
                                        Tc : req.body.tasa_cambio,
                                        Moneda : req.body.moneda,
                                        D_H: req.body.tipo_documento == "09" ? 'D' : 'H',
                                    });
                                    ...
                                    fila_contable.push({
                                        ...
                                        codigo_auxiliar : req.body.codigo_cliente,
                                        nombre_auxiliar : req.body.nombre_cliente,
                                        debe : req.body.tipo_documento == "09" ? calculos_mn_me.Debe : 0,
                                        debe_mn : req.body.tipo_documento == "09" ? calculos_mn_me.Debe_MN : 0,
                                        debe_me : req.body.tipo_documento == "09" ? calculos_mn_me.Debe_ME : 0,
                                        haber : req.body.tipo_documento == "09" ? 0 : calculos_mn_me.Haber,
                                        haber_mn : req.body.tipo_documento == "09" ? 0 : calculos_mn_me.Haber_MN,
                                        haber_me : req.body.tipo_documento == "09" ? 0 : calculos_mn_me.Haber_ME,
                                        d_h : req.body.tipo_documento == "09" ? 'D' : 'H',
                                        Si_Diferencia : 'N',
                                        Si_Transferencia : 'N',
                                        Tipo_Origen : 'N',
                            ...
                            for(var j=0;j<fila_contable.length;j++){
                                ...
                                .input('ctip_docref',mssql.VarChar(250), fila_contable[j].Tipo_Documento || '09')
                                .input('cnum_serieref',mssql.VarChar(250),fila_contable[j].Serie_Documento ||  req.body.motivo)
...
router.post('/lista', async (req, res) => {
    try {
        ...
        "WHERE hmovialc.modulo = 'GUIA_VENTA' and Hmovialc.ccod_empresa = @codigo_empresa AND    "+
        "hmovialc.ccod_almacen = @codigo_punto_venta "+ opcion+
